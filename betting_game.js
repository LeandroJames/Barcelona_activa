...
const menu = () => { 
return new inquirer
  .prompt([{type: "list", name:"otherRound", message:"Play another round?", choices:["Yes", "No"]} 
  ])
  .then(answer => {
    ...
    if (answer.otherRound=="No") {console.log(`You made ${moneyMade} fictional euros. Congratulations`)}
  })}
